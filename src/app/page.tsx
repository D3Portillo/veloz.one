    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-100">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            ...
            <Button
              className="bg-veloz-primary hover:bg-veloz-primary/90 h-auto px-4 py-1.5 rounded-lg text-white"
              asChild
            >
      ...
      <section className="py-32 min-h-screen bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button
              className="bg-veloz-primary gap-4 rounded-full hover:bg-veloz-primary/90 text-white text-lg px-6"
              asChild
            >
              <a href="https://tally.so/r/3xGgzE" target="_blank">
      ...
      <section className="py-32 bg-veloz-primary">
        <div className="container mx-auto px-4 text-center text-white">
          ...
          <div className="flex flex-col-reverse sm:flex-row gap-5 justify-center items-center">
            <Button
              className="bg-white w-full sm:w-auto justify-between text-veloz-primary hover:bg-gray-100 text-lg"
              asChild
            >
              <a href="https://tally.so/r/3xGgzE" target="_blank">
            ...
            <Button
              className="hover:underline w-full sm:w-auto justify-between underline-offset-4 text-white/95 bg-gradient-to-br from-white/10 to-white/5 border border-white/15 text-lg"
              asChild
            >
              <a href="https://twitter.com/veloz_one" target="_blank">
                <span>Follow @veloz_one</span>
                <FaTwitter className="sm:hidden" />
              </a>
            </Button>
          </div>
        </div>
      ...
      <footer className="bg-black text-white/80 pt-24 pb-5 sm:pb-24">
        <div className="container mx-auto px-4">
          ...
          <Separator className="mb-4 mt-24 sm:mt-12 bg-white/25" />
